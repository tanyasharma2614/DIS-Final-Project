...
def simulate_env_medium(strategy):
    ...
    for i in range(len(packets)):
        ...
        if strategy == "Heaps":
            ...
            server.add_packet(packet)
    loadVStime(servers, strategy, 'medium')
    meanstdVStime(servers, strategy, 'medium')
    throughputVStime(servers, strategy, 'medium')
    responsetimeVStime(servers,strategy, 'medium')
